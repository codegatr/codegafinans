...
<nav class="cf-bottomnav" aria-label="Alt menu">
    ...
    <a href="/debts.php"        class="<?= str_contains($_SERVER['REQUEST_URI'] ?? '', 'debts.php')        ? 'active' : '' ?>" aria-label="Borclar">
    ...
    <a href="/budgets.php"      class="<?= str_contains($_SERVER['REQUEST_URI'] ?? '', 'budgets.php')      ? 'active' : '' ?>" aria-label="Butce">
